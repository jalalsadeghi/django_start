...
LOCAL_APPS = [
    'dp.core.apps.CoreConfig',
    'dp.common.apps.CommonConfig',
    'dp.blog.apps.BlogConfig',
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='psql://dp:dp123@127.0.0.1:5432/dp'),
}
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'dp.api.exception_handlers.drf_default_with_modifications_exception_handler',
